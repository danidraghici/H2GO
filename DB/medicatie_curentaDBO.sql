/****** Object:  Table [dbo].[medicatie_curenta]    Script Date: 23.05.2025 18:53:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[medicatie_curenta](
 ...
 CONSTRAINT [PK_medicatie_curenta] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
ALTER TABLE [dbo].[medicatie_curenta]  WITH CHECK ADD  CONSTRAINT [FK_CNP_PACIENT_MEDICATIE] FOREIGN KEY([cnp_pacient])
REFERENCES [dbo].[pacienti] ([CNP])
GO

ALTER TABLE [dbo].[medicatie_curenta] CHECK CONSTRAINT [FK_CNP_PACIENT_MEDICATIE]
GO
